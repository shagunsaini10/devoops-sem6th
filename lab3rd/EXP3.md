...
```
![Docker Pull](part1/images/dock-pull.png)

### Step 2: Run the Container
```bash
docker run -d --name nginx-official -p 8080:80 nginx
```
![Docker Run](part1/images/dock-run.png)

### Step 3: Verify
```bash
curl http://localhost:8080
```
![Curl Output](part1/images/curl-cmd.png)

### Key Observations
```bash
docker images nginx
```
![Docker Images](part1/images/dock-img-nginx.png)
...
```
![Create Dockerfile](part1/images/dockfile.png)

### Step 2: Build Image
```bash
docker build -t nginx-ubuntu .
```
![Build 1](part1/images/dock-build.png)
![Build 2](part1/images/dock-build.png)

### Step 3: Run Container
```bash
docker run -d --name nginx-ubuntu -p 8081:80 nginx-ubuntu
```
![Run Container](part1/images/dock-run2.png)

### Observations
```bash
docker images nginx-ubuntu
```
![Docker Images](part1/images/dock-img-nginx-ubuntu.png)
...
CMD ["nginx", "-g", "daemon off;"]
```
![Create Dockerfile](part1/images/dockerfile2.png)

### Step 2: Build Image
```bash
docker build -t nginx-alpine .
```
![Build](part1/images/docker-build-alpine.png)

### Step 3: Run Container
```bash
docker run -d --name nginx-alpine -p 8082:80 nginx-alpine
```
![Run Container](part1/images/dock-alpine.png)
...
```
![nginx History](part1/images/dock-hist-nginx.png)
```bash
docker history nginx-ubuntu
```
![nginx-ubuntu History](part1/images/dock-hist-nginx.png)
```bash
docker history nginx-alpine
```
![nginx-alpine History](part1/images/dock-hist-alpine.png)
...
docker run -d \
  ...
  nginx
```
![Run Container](part5/images/dock-run.png)
